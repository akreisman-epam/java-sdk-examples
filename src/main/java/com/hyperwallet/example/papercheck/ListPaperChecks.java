...
public class ListPaperChecks {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HyperwalletList<HyperwalletPaperCheck>
            paperChecks =
            client.listPaperChecks("usr-b4a1f0bd-cbf7-4467-aa6f-4445dea7e67d", options);

        System.out.println(ToStringBuilder.reflectionToString(paperChecks, new MultilineRecursiveToStringStyle()));
    }
