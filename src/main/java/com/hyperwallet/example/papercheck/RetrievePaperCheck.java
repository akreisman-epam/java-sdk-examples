...
public class RetrievePaperCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HyperwalletPaperCheck
            paperCheck =
            client.getPaperCheck("usr-b4a1f0bd-cbf7-4467-aa6f-4445dea7e67d",
                               "trm-b379ca8e-973a-47d4-a79c-eaaf2af89ee6");

        System.out.println(ToStringBuilder.reflectionToString(paperCheck, new MultilineRecursiveToStringStyle()));
    }
}
